export default function GFFLogo({ size = 22 }: { size?: number }) {
  return (
    <svg width={size} height={size * 1.15} viewBox="0 0 44 50" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      {/* Simple ball glyph */}
      <circle cx="22" cy="23" r="8.5" fill="#B45309" />
      <path d="M22 16.5L26 19.3L24.5 24.2H19.5L18 19.3L22 16.5Z" fill="#FFFFFF" />
      <path d="M22 16.5V13.5M26 19.3L29 17.3M24.5 24.2L26 27.5M19.5 24.2L18 27.5M18 19.3L15 17.3" stroke="#FFFFFF" strokeWidth="1" strokeLinecap="round" />
    </svg>
  );
}
